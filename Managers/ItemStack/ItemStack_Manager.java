package net.perforce.jayapi.Managers.ItemStack;

import net.perforce.jayapi.Managers.ItemStack.Utils.*;
...
public class ItemStack_Manager {
    ...
    /** ------------------------------------------------------------------------------------------------------------------- */
    /**                                                                                                                     */
    public ItemStack addEnchantments(ItemStack itemStack, HashMap<Enchantment, Integer> enchantments, boolean hidden) {
    ...
    /** ----------------------------------------------------------------------------------- */
    /**                                                                                     */
    public ItemStack addItemFlags(ItemStack itemStack, ArrayList<ItemFlag> itemFlags) {
    ...
    /** -------------------------------------------------------------------------------------------------------------------------------------- */
    /**                                                                                                                                        */
    public ItemStack createBookItemStack(String author, ArrayList<String> pages, int amount, String displayName) {
        return createBookItemStack.createBookItemStack(author, pages, amount, displayName);
    }
    /**                                                                                                                                        */
    public ItemStack createBookItemStack(String author, ArrayList<String> pages, int amount, String displayName, ArrayList<String> lore) {
    ...
    /** ----------------------------------------------------------------------------------------------------------------------- */
    /**                                                                                                                         */
    public ItemStack createItemStack(Material material, int amount, int type) {
        return createItemStack.createItemStack(material, amount, type);
    }
    /**                                                                                                                         */
    public ItemStack createItemStack(Material material, int amount, int type, String displayName) {
        return createItemStack.createItemStack(material, amount, type, displayName);
    }
    /**                                                                                                                         */
    public ItemStack createItemStack(Material material, int amount, int type, String displayName, ArrayList<String> lore) {
        return createItemStack.createItemStack(material, amount, type, displayName, lore);
    }
    /**                                                                                                                         */
    public ItemStack createItemStack(Material material, int amount, int type, ArrayList<String> lore) {
    ...
    /** ---------------------------------------------------------------------------------------------------------------------------------------------------------- */
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, Color color) {
        return createLeatherArmorItemStack.createLeatherArmorItemStack(material, color);
    }
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, Color color, String displayName) {
        return createLeatherArmorItemStack.createLeatherArmorItemStack(material, color, displayName);
    }
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, Color color, String displayName, ArrayList<String> lore) {
        return createLeatherArmorItemStack.createLeatherArmorItemStack(material, color, displayName, lore);
    }
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, Color color, ArrayList<String> lore) {
        return createLeatherArmorItemStack.createLeatherArmorItemStack(material, color, lore);
    }
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, int redValue, int greenValue, int blueValue) {
        return createLeatherArmorItemStack.createLeatherArmorItemStack(material, redValue, greenValue, blueValue);
    }
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, int redValue, int greenValue, int blueValue, String displayName) {
        return createLeatherArmorItemStack.createLeatherArmorItemStack(material, redValue, greenValue, blueValue, displayName);
    }
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, int redValue, int greenValue, int blueValue, String displayName, ArrayList<String> lore) {
        return createLeatherArmorItemStack.createLeatherArmorItemStack(material, redValue, greenValue, blueValue, displayName, lore);
    }
    /**                                                                                                                                                            */
    public ItemStack createLeatherArmorItemStack(Material material, int redValue, int greenValue, int blueValue, ArrayList<String> lore) {
    ...
    /** -------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
    /**                                                                                                                                                                      */
    public ItemStack createPotionItemStack(PotionEffectType mainEffect, ArrayList<PotionEffect> potionEffects, int amount) {
        return createPotionItemStack.createPotionItemStack(mainEffect, potionEffects, amount);
    }
    /**                                                                                                                                                                      */
    public ItemStack createPotionItemStack(PotionEffectType mainEffect, ArrayList<PotionEffect> potionEffects, int amount, String displayName) {
        return createPotionItemStack.createPotionItemStack(mainEffect, potionEffects, amount, displayName);
    }
    /**                                                                                                                                                                      */
    public ItemStack createPotionItemStack(PotionEffectType mainEffect, ArrayList<PotionEffect> potionEffects, int amount, String displayName, ArrayList<String> lore) {
        return createPotionItemStack.createPotionItemStack(mainEffect, potionEffects, amount, displayName, lore);
    }
    /**                                                                                                                                                                      */
    public ItemStack createPotionItemStack(PotionEffectType mainEffect, ArrayList<PotionEffect> potionEffects, int amount, ArrayList<String> lore) {
    ...
    /** ------------------------------------------------------------------------------------------------------------------ */
    /**                                                                                                                    */
    public ItemStack createSkullItemStack(String skullOwner, int amount) {
        return createSkullItemStack.createSkullItemStack(skullOwner, amount);
    }
    /**                                                                                                                    */
    public ItemStack createSkullItemStack(String skullOwner, int amount, String displayName) {
        return createSkullItemStack.createSkullItemStack(skullOwner, amount, displayName);
    }
    /**                                                                                                                    */
    public ItemStack createSkullItemStack(String skullOwner, int amount, String displayName, ArrayList<String> lore) {
        return createSkullItemStack.createSkullItemStack(skullOwner, amount, displayName, lore);
    }
    /**                                                                                                                    */
    public ItemStack createSkullItemStack(String skullOwner, int amount, ArrayList<String> lore) {
